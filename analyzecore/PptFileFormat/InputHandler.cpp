...
#include "Common.h"
#include "../SimpleStream/SimpleStream.h"
#include "../SimpleStream/file_istream.h"
...
{
	_spStream = make_shared<simple::file_istream>(fileName.c_str());
}

InputHandler::InputHandler(shared_ptr<simple::file_istream>& spStream)
{
	_spStream = spStream;
}
