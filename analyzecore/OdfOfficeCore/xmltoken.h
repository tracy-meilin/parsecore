	...
	namespace token {
		...
		*/
		enum XMLTokenEnum
		{
			...
			XML_TEXT_SOFTEDGE,
			XML_TEXT_REFLECTION,
			XML_TEXT_COLOR_OPACITY,
			XML_TEXT_STROKE,
			XML_TEXT_STROKE_COLOR,
			XML_TEXT_STROKE_WIDTH,
			XML_TEXT_STROKE_OPACITY,
			XML_TEXT_STYLE,
			XML_TEXT_TRANSFORM,
			XML_TEXT_UNDERLINE,
			...
			*/
			...
			XML_EXTERNER_3DSOURCE,
			XML_EXTERNER_VRSOURCE,
			XML_EXTERNER_FLASHSOURCE,
			XML_EXTERNER_QUESTIONSOURCE,

			XML_NUMBER_COLUMN,
			XML_TEXT_SPC_COLUMN,
			XML_TEXTBODY_VERT,
			XML_TEXTBODY_FROM_WORDART,
			XML_TEXTBODY_SCENE3D,
			XML_TEXTBODY_SCENE3D_PRST,
			XML_TEXTBODY_SP3D,

			XML_GLOW,
			XML_GLOW_COLOR,
			XML_GLOW_RAD,
			XML_GLOW_TRANSPARENCE,
			XML_SOFTEDGE,
			XML_SOFTEDGE_RAD,
			XML_PRSTGEOM_PRST,
			XML_REFLECTION_SWITCH,
			//        XML_REFLECTION_BLURRAD,
			//        XML_REFLECTION_STA,
			//        XML_REFLECTION_DIR,
			//        XML_REFLECTION_ENDA,
			//        XML_REFLECTION_ENDPOS,
			//        XML_REFLECTION_DIST,
			//        XML_REFLECTION_SY,
			//        XML_REFLECTION_ALGN,
			//        XML_REFLECTION_ROTWITHSHAPE,

			XML_SHAPE3D,
			//        XML_SHAPE3D_CAMERA_FOV,
			//        XML_SHAPE3D_CAMERA_ZOOM,
			XML_SHAPE3D_CAMERA_PRST,
			//        XML_SHAPE3D_CAMERA_ROTLAT,
			//        XML_SHAPE3D_CAMERA_ROTLON,
			//        XML_SHAPE3D_CAMERA_ROTREV,
			//        XML_SHAPE3D_LIGHT_DIR,
			//        XML_SHAPE3D_LIGHT_RIG,
			//        XML_SHAPE3D_LIGHT_ROTLAT,
			//        XML_SHAPE3D_LIGHT_ROTLON,
			//        XML_SHAPE3D_LIGHT_ROTREV,
			XML_SHAPE3D_SP3D,
			//        XML_SHAPE3D_EXTRUSION_H,
			//        XML_SHAPE3D_CONTOUR_W,
			//        XML_SHAPE3D_Z,
			XML_SHAPE3D_PRST_MATERIAL,
			//        XML_SHAPE3D_BEVELT_W,
			//        XML_SHAPE3D_BEVELT_H,
			//        XML_SHAPE3D_BEVELT_PRST,
			//        XML_SHAPE3D_BEVELB_W,
			//        XML_SHAPE3D_BEVELB_H,
			//        XML_SHAPE3D_BEVELB_PRST,
			//        XML_SHAPE3D_EXTRUSION_COLOR,
			//        XML_SHAPE3D_CONTOUR_COLOR,
			XML_THRESH,
			XML_ORIGION_SERVICE,
			XML_ORIGIN_CX,
