...
#define TOKEN( s, e ) { sizeof(s)-1, s, nullptr }
		...
		*/
		...
		TOKEN("text-glow", XML_TEXT_GLOW),
		TOKEN("text-softedge", XML_TEXT_SOFTEDGE),
		TOKEN("text-reflection", XML_TEXT_REFLECTION),
		TOKEN("color-opacity", XML_TEXT_COLOR_OPACITY),
		TOKEN("text-stroke", XML_TEXT_STROKE),
		TOKEN("text-stroke-color", XML_TEXT_STROKE_COLOR),
		TOKEN("text-stroke-width", XML_TEXT_STROKE_WIDTH),
		TOKEN("text-stroke-opacity", XML_TEXT_STROKE_OPACITY),
		...
		*/
		...
		TOKEN("externer-3D-source", XML_EXTERNER_3DSOURCE),
		TOKEN("externer-vr-source", XML_EXTERNER_VRSOURCE),
		TOKEN("externer-flash-source", XML_EXTERNER_FLASHSOURCE),
		TOKEN("externer-question-source", XML_EXTERNER_QUESTIONSOURCE),

		TOKEN("column-number", XML_NUMBER_COLUMN),
		TOKEN("column-spc", XML_TEXT_SPC_COLUMN),
		TOKEN("textbody-vert", XML_TEXTBODY_VERT),
		TOKEN("textbody-from-wordart", XML_TEXTBODY_FROM_WORDART),
		TOKEN("textbody-scene3d", XML_TEXTBODY_SCENE3D),
		TOKEN("textbody-scene3d_prst", XML_TEXTBODY_SCENE3D_PRST),
		TOKEN("textbody-sp3d", XML_TEXTBODY_SP3D),

		TOKEN("glow", XML_GLOW),
		TOKEN("glow-color", XML_GLOW_COLOR),
		TOKEN("glow-rad", XML_GLOW_RAD),
		TOKEN("glow-transparence", XML_GLOW_TRANSPARENCE),

		TOKEN("softedge", XML_SOFTEDGE),
		TOKEN("softedge-rad", XML_SOFTEDGE_RAD),
		TOKEN("prstgeom-prst", XML_PRSTGEOM_PRST),
		TOKEN("reflection-switch", XML_REFLECTION_SWITCH),
		//TOKEN("reflection-blurrad", XML_REFLECTION_BLURRAD),
		//TOKEN("reflection-sta", XML_REFLECTION_STA),
		//TOKEN("reflection-dir", XML_REFLECTION_DIR),
		//TOKEN("reflection-enda", XML_REFLECTION_ENDA),
		//TOKEN("reflection-endpos", XML_REFLECTION_ENDPOS),
		//TOKEN("reflection-dist", XML_REFLECTION_DIST),
		//TOKEN("reflection-sy", XML_REFLECTION_SY),
		//TOKEN("reflection-algn", XML_REFLECTION_ALGN),
		//TOKEN("reflection-rotwithshape", XML_REFLECTION_ROTWITHSHAPE),

		TOKEN("shape3d", XML_SHAPE3D),
		//TOKEN("shape3d-camera-fov", XML_SHAPE3D_CAMERA_FOV),
		//TOKEN("shape3d-camera-zoom", XML_SHAPE3D_CAMERA_ZOOM),
		TOKEN("shape3d-camera-prst", XML_SHAPE3D_CAMERA_PRST),
		//TOKEN("shape3d-camera-rotlat", XML_SHAPE3D_CAMERA_ROTLAT),
		//TOKEN("shape3d-camera-rotlon", XML_SHAPE3D_CAMERA_ROTLON),
		//TOKEN("shape3d-camera-rotrev", XML_SHAPE3D_CAMERA_ROTREV),
		//TOKEN("shape3d-lightrig-dir", XML_SHAPE3D_LIGHT_DIR),
		//TOKEN("shape3d-lightrig-rig", XML_SHAPE3D_LIGHT_RIG),
		//TOKEN("shape3d-lightrig-rotlat", XML_SHAPE3D_LIGHT_ROTLAT),
		//TOKEN("shape3d-lightrig-rotlon", XML_SHAPE3D_LIGHT_ROTLON),
		//TOKEN("shape3d-lightrig-rotrev", XML_SHAPE3D_LIGHT_ROTREV),
		TOKEN("shape3d-sp3d", XML_SHAPE3D_SP3D),
		//TOKEN("shape3d-sp3d-extrusionh", XML_SHAPE3D_EXTRUSION_H),
		//TOKEN("shape3d-sp3d-contourw", XML_SHAPE3D_CONTOUR_W),
		//TOKEN("shape3d-sp3d-z", XML_SHAPE3D_Z),
		TOKEN("shape3d-sp3d-prstmaterial", XML_SHAPE3D_PRST_MATERIAL),
		//TOKEN("shape3d-sp3d-beveltw", XML_SHAPE3D_BEVELT_W),
		//TOKEN("shape3d-sp3d-bevelth", XML_SHAPE3D_BEVELT_H),
		//TOKEN("shape3d-sp3d-beveltprst", XML_SHAPE3D_BEVELT_PRST),
		//TOKEN("shape3d-sp3d-bevelbw", XML_SHAPE3D_BEVELB_W),
		//TOKEN("shape3d-sp3d-bevelbh", XML_SHAPE3D_BEVELB_H),
		//TOKEN("shape3d-sp3d-bevelbprst", XML_SHAPE3D_BEVELB_PRST),
		//TOKEN("shape3d-sp3d-extrusioncolor", XML_SHAPE3D_EXTRUSION_COLOR),
		//TOKEN("shape3d-sp3d-contourcolor", XML_SHAPE3D_CONTOUR_COLOR),
		TOKEN("thresh", XML_THRESH),
		TOKEN("origion-service", XML_ORIGION_SERVICE),
		TOKEN("xml-origin-cx", XML_ORIGIN_CX),
		...
		const wstring& GetXMLToken(enum XMLTokenEnum eToken)
		{
#if OSL_DEBUG_LEVEL > 0
			...
			if (!pToken->pOUString)
			{
				string strTmp = string(pToken->pChar);

				std::wstring_convert< std::codecvt_utf8<wchar_t> > strCnv;
				return strCnv.from_bytes(strTmp);
			}
		...
		enum XMLTokenEnum eToken)
		{
			...
			string strCharTmp = string(pToken->pChar);

			std::wstring_convert< std::codecvt_utf8<wchar_t> > strCnv;
			wstring strTmp = strCnv.from_bytes(strCharTmp);

			return rString == strTmp;
		}
	}
}